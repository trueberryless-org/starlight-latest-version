...
The Starlight Latest Version plugin fetches the latest release of your package as specified in the [`source` configuration option](/configuration/#source).

## Regex Pattern

The Starlight Latest Version plugin uses a regex pattern to extract the version (and prerelease). The default pattern is:
